# Graph Report - Transit_SLTT  (2026-08-16)

## Corpus Check
- 906 files · ~896,982 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3154 nodes · 13296 edges · 183 communities (112 shown, 71 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 60 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1b0b4632`
...
- serwist
- tesseract.js
- devis-detail-screen.tsx
- dossiers-list-screen.tsx
- @radix-ui/react-dropdown-menu
- InstallPWA.tsx
- template.ts
...
1. `cn()` - 396 edges
2. `formatFCFA()` - 265 edges
3. `useStore` - 217 edges
4. `Button()` - 177 edges
5. `useToast()` - 169 edges
6. `Card()` - 132 edges
7. `formatDateShort()` - 127 edges
8. `UI` - 114 edges
9. `toastSuccess()` - 89 edges
10. `Input()` - 88 edges
...
Cohesion: 0.10
Nodes (18): BonFormDialog(), BonFormDialogProps, ClasseurImportDialog(), Phase, ReviewRow, StatPill(), BonFormDialog(), BonFormDialogProps (+10 more)
...
Cohesion: 0.13
Nodes (12): inter, metadata, sora, viewport, PwaGlobalEffects(), PwaUpdatePrompt(), AppSerwistProvider(), AppRoot() (+4 more)

### Community 3 - "store.ts"
Cohesion: 0.11
Nodes (32): ProfilePublicRow, mapAnnexeFromDb(), fetchCoreEntities(), PagedFetchResult, buildSecondaryFetchSpecs(), fetchSecondaryEntities(), SECONDARY_FETCH_KEYS, SecondaryFetchKey (+24 more)

### Community 4 - "dossiers-slice.ts"
Cohesion: 0.12
Nodes (9): PageProps, PageProps, PageProps, PageProps, PageProps, RouteSync(), RouteSyncProps, pathForView() (+1 more)

### Community 5 - "require-admin.ts"
Cohesion: 0.09
Nodes (34): ClotureDialog(), dayAfter(), firstDayOfMonth(), today(), JournalCaissePanelProps, OperationsTableProps, NATURE_SUGGESTIONS, entiteKeyOf() (+26 more)

### Community 6 - "utils.ts"
Cohesion: 0.10
Nodes (33): ConvertDevisDialogProps, DevisFormProps, DevisFormProps, mapDevisFromDb(), Devis, DevisInput, DevisListPrintRow, BonSortieCaisseRow (+25 more)

### Community 7 - "domain-types.ts"
Cohesion: 0.08
Nodes (22): DevisActionsCard(), FinancialSummary(), InformationsCard(), LignesTable(), FactureRowProps, DOSSIER_STATUT_DOT, FinancialSummary(), InfoRow() (+14 more)
...
Cohesion: 0.07
Nodes (35): beneficiairesSummary(), CaisseMobileCard(), CaisseTableRow(), BonPreview(), DossiersTab(), FacturesTab(), EcrituresTable(), DevisListTable() (+27 more)

### Community 10 - "useStore"
Cohesion: 0.09
Nodes (38): EcrituresTableProps, PaymentDialogProps, EcrituresTableProps, PaymentDialogProps, syncClientStats(), DEFAULT_PAIEMENT_MODE, DOSSIER_STATUT_DEDOUANE, DOSSIER_STATUT_EN_COURS (+30 more)
...
Cohesion: 0.08
Nodes (56): RecapRow, SortableHead(), BonCaisseTabProps, PreviewState, DossiersTabProps, FacturesTabProps, ClientMobileCard, ClientsTableProps (+48 more)

### Community 14 - "calendrier.tsx"
Cohesion: 0.09
Nodes (38): DevisNextStatut, DevisStatutConfig, NEXT_STATUT, STATUT_CONFIG, STATUT_FLOW, STATUTS_ALL, DevisSummaryHeader(), DossierDetailStepper() (+30 more)
...
Cohesion: 0.24
Nodes (9): GuideDemarrage(), GuideDemarrage(), getGuideProgress(), getGuideStepsForRole(), GUIDE_STEP_DEFS, GuideStepDef, GuideStepId, GuideStoreSnapshot (+1 more)
...
Cohesion: 0.04
Nodes (66): ChartPayloadItem, ChartTooltip(), PiePayloadItem, PieTooltip(), EvolutionChartCard(), EvolutionChartCardProps, RecapClientCard(), PieDatum (+58 more)

### Community 21 - "cn"
Cohesion: 0.11
Nodes (27): ARCHIVE_COLUMNS, ArchiveTab, DocSource, RattachementKind, TAB_META, TYPE_DOC_BADGE, TYPES_DOCUMENT, UnifiedDoc (+19 more)
...
Cohesion: 0.29
Nodes (5): ClasseurGridImpl, ClasseurGridLazy(), ClasseurGridImpl, ClasseurGridLazy(), ClasseurEntry
...
Cohesion: 0.10
Nodes (36): AnnexePicker(), PasswordField(), RolePicker(), allRoles, emptyFormState(), FormMode, FormTab, isCustomPermissionSet() (+28 more)

### Community 30 - "csv-export.ts"
Cohesion: 0.11
Nodes (44): deriveStatut(), today(), useEcrituresScreen(), DossierBulkImportButton(), useDossierFormActions(), buildDossierPrefill(), useFacturesScreen(), useFournisseursScreen() (+36 more)

### Community 31 - "ag-grid-community"
Cohesion: 0.07
Nodes (56): PATCH(), RouteContext, POST(), RouteContext, AdminClient, assertNotLastActiveAdmin(), DELETE(), PATCH() (+48 more)

### Community 32 - "classeur.ts"
Cohesion: 0.23
Nodes (30): printClients(), htmlEscape(), acquirePrintTarget(), brandLogoImgHTML(), buildBrandSubHTML(), buildLegalLine(), buildPrintDocument(), documentFooterHTML() (+22 more)
...
Cohesion: 0.08
Nodes (9): OfflineIndicator(), AppShell(), Bone(), ScreenSkeleton(), BilansScreen(), DossierFormScreen(), DossiersListScreen(), FacturesScreen() (+1 more)

### Community 40 - "@radix-ui/react-toast"
Cohesion: 0.06
Nodes (75): ArchiveUploadDialog(), BonCaisseTab(), ClasseurGrid(), ClasseurGridProps, OperationFormDialog(), today(), ContratFileDropZone(), ConvertDevisDialog() (+67 more)
...
Cohesion: 0.46
Nodes (5): computeBenefice(), filterBySocieteAndPeriode(), BeneficeMensuel, BeneficeParSocieteEntry, useBeneficeParSociete()

### Community 45 - "ag-grid-community"
Cohesion: 0.10
Nodes (30): DossierFormState, UseDossierFormActionsOptions, numStr(), useDossierFormState(), UseDossierFormStateOptions, getNextTransition(), DossiersListTable(), SORT_OPTIONS (+22 more)

### Community 46 - "ecritures-panel.tsx"
Cohesion: 0.14
Nodes (19): FactureDocumentHeader(), BuildPrintDocumentOptions, BonSortieCaisseModuleData, ANNEXE_DOSSIER_COUT_LABELS, buildInvoiceBrandBlocks(), buildLegalLineHTML(), DEFAULT_DOSSIER_COUT_LABELS, DossierCoutLabels (+11 more)

### Community 47 - "guide-progress.ts"
Cohesion: 0.08
Nodes (45): AuditAction, AuditEntry, AuditModule, AuditSourceRef, insertAuditLog(), mapAuditLogFromDb(), resolveClientIp(), ArchiveRow (+37 more)
...
Cohesion: 0.09
Nodes (31): BonSortieCaisseLigneRow, BonSortieStatut, ClotureCaisseRow, DossierFournisseurRow, DossierFournisseurStatut, FactureLigneRow, FournisseurRow, ModeTransport (+23 more)
...
Cohesion: 0.10
Nodes (16): TONE_CLASSES, ClientFormFields(), Props, ContratFormModal(), DepenseFormModal(), PrestationFormModal(), CONTRAT_STATUT_TONE, CONTRAT_STATUTS (+8 more)

### Community 101 - "operation-form-dialog.tsx"
Cohesion: 0.11
Nodes (54): EcrituresFiltersProps, FormState, NewEcritureDialogProps, modeIcon, modeOptions, StatutFilter, DEVIS_SORT_OPTIONS, CATEGORIES (+46 more)

### Community 104 - "import-dialog.tsx"
Cohesion: 0.06
Nodes (41): ClotureDialogProps, ImportAnyDialog(), ImportAnyDialogProps, isExcelFile(), CheckedState, ComptabiliteGeneraleImportDialog(), ImportDialogProps, Phase (+33 more)

### Community 105 - "dossier-bulk-import-dialog.tsx"
Cohesion: 0.04
Nodes (64): ClientProfileCard(), ClientProfileCardProps, avatarGradient(), SortableHeader(), Heading(), Heading(), AdminPanel(), DevisPipelineCard() (+56 more)

### Community 107 - "use-excel-workbook.ts"
Cohesion: 0.14
Nodes (23): LogistiqueTab(), ClientFicheScreen(), FICHE_TABS, FicheTab, emptyClientForm(), AuditSourceType, buildClasseurJournal(), buildDossierLibelle() (+15 more)
...
Cohesion: 0.06
Nodes (57): CONTRAT_STATUT_TONE, CONTRAT_STATUTS, MODES_PAIEMENT, PRESTATION_STATUT_TONE, PRESTATION_STATUTS, syncContratStats(), BaseContrat, AnnexeRow (+49 more)

### Community 116 - "classeur-tab.tsx"
Cohesion: 0.05
Nodes (54): BonMarchandiseTab(), BonMarchandiseTabProps, BonMobileCard(), BonTableRow(), BON_MOTIF_TONE, BON_MOTIFS, BON_STATUT_TONE, useBonFilters() (+46 more)
...
Cohesion: 0.14
Nodes (12): Benefice, BeneficeKpiRow(), BeneficeKpiRowProps, BeneficeParSociete, EcrituresFilters(), EcrituresPanelProps, NewEcritureDialog(), PaymentDialog() (+4 more)
...
Cohesion: 0.26
Nodes (9): FieldLine(), RecuReceiptBody(), RecuReceiptBodyProps, montantEnLettresFCFA(), numberToWordsFr(), TENS, threeDigitsToWords(), twoDigitsToWords() (+1 more)
...
Cohesion: 0.16
Nodes (18): react, react, buildRecuPrintData(), printRecu(), printRecuFromForm(), RecuFormModuleInput, resolveGeneratorBrand(), resolveRecuBrand() (+10 more)

### Community 133 - "contrats.tsx"
Cohesion: 0.24
Nodes (14): PendingConfirm, UseExcelWorkbookParams, ClasseurType, excelTheme, cellToNumber(), cellToString(), ecritureClasseurReference(), injectGrandLivre() (+6 more)

### Community 134 - "template.ts"
Cohesion: 0.33
Nodes (10): RecapClientCardProps, currentYearMonth(), getPeriodeLabel(), Periode, PERIODES, SortDir, SortKey, useBilansScreen() (+2 more)
...
Cohesion: 0.09
Nodes (46): ContratFichierRow, DocumentRow, DocumentVersionRow, OcrFieldRow, buildDocumentStoragePath(), dataUrlToBlob(), getSignedDocumentUrl(), removeDocumentStoragePaths() (+38 more)

### Community 139 - "sync-sequences.ts"
Cohesion: 0.19
Nodes (15): BreadcrumbNav(), DETAIL_PARENT, NavItem, navItems, VIEW_PERMISSIONS, ComptaTab, ViewKey, hasPermission() (+7 more)

### Community 140 - "command-palette.tsx"
Cohesion: 0.08
Nodes (25): RecuGeneratorForm(), RecuGeneratorFormProps, STATUT_BADGE_CLASS, STATUT_LABELS, RecuGeneratorActions(), RecuGeneratorForm(), RecuGeneratorFormProps, STATUT_BADGE_CLASS (+17 more)
...
Cohesion: 0.13
Nodes (19): AnnexeSelector(), CommandPalette(), NavList(), NavSectionLabel(), Sidebar(), SidebarBrand(), Topbar(), viewTitles (+11 more)

### Community 155 - "ocr-review-dialog.tsx"
Cohesion: 0.05
Nodes (49): extractClientIp(), GET(), avatarGradient(), ClientSortKey, ClientTypeFilter, rowAccentClass(), SORT_OPTIONS, ClientTypeBadge() (+41 more)

### Community 156 - "clsx"
Cohesion: 0.50
Nodes (3): secureRuntimeCaching, serwist, WorkerGlobalScope

### Community 157 - "ecritures-panel.tsx"
Cohesion: 0.13
Nodes (12): Benefice, BeneficeKpiRow(), BeneficeKpiRowProps, BeneficeParSociete, EcrituresFilters(), EcrituresPanelProps, NewEcritureDialog(), PaymentDialog() (+4 more)

### Community 158 - "dashboard-screen.tsx"
Cohesion: 0.18
Nodes (11): AgentPanel(), AlertesCard(), ComptablePanel(), DossiersEvolutionChart(), MagasinierPanel(), DashboardScreen(), DashboardSection, getDashboardSections() (+3 more)

### Community 164 - "classeur-import.ts"
Cohesion: 0.30
Nodes (15): buildColMapFromRow(), cellToString(), countFilledCells(), HEADER_ALIASES, looksLikeDataRow(), looksLikeGrandLivreHeaderRow(), normalizeHeader(), parseAmount() (+7 more)
...
Cohesion: 0.28
Nodes (13): useDashboardMetrics(), DOSSIER_STATUT_HEX, useDashboardMetrics(), buildDossiersParMois(), buildEcartsParPeriode(), buildEncaissementsParMois(), buildLiveAlertes(), buildStockRepartition() (+5 more)

### Community 172 - "devis-detail-screen.tsx"
Cohesion: 0.12
Nodes (15): ConfirmActionDialog(), DevisFormDialog(), DevisListBanner(), DevisListFilters(), DevisSortKey, InfoCallout(), PageHeader(), ContratDetailScreen() (+7 more)

### Community 173 - "dossiers-list-screen.tsx"
Cohesion: 0.09
Nodes (20): TYPE_META, TYPES, LiaisonEnrichie, FournisseurTab, TAB_META, FilterChip, ListFilters(), ListFiltersProps (+12 more)
...
Cohesion: 0.17
Nodes (18): buildRecuPrintData(), formToModuleData(), printRecu(), printRecuFromForm(), RecuFormModuleInput, resolveGeneratorBrand(), resolveRecuBrand(), toRecuModuleData() (+10 more)

### Community 181 - "InstallPWA.tsx"
Cohesion: 0.43
...
Cohesion: 0.17
Nodes (23): ConfirmDeleteDialog(), DossierDetailOverview(), TransitionDialog(), BonCaisseTab(), DossierDetailScreen(), DossierAmountsSection(), RecuGeneratorActionsProps, calculateDaysUntil() (+15 more)

### Community 184 - "index.ts"
Cohesion: 0.25
Nodes (9): devisInputSchema, DevisData, DevisListPrintRow, fmtDevisDate(), fmtDevisDateShort(), prestataireDisplayName(), printDevis(), printDevisList() (+1 more)
...
### Community 190 - "use-recu-preview-scale.ts"
Cohesion: 0.14
Nodes (15): RECEIPT_H_PX, RECEIPT_W_PX, RecuReceiptHeader(), RecuReceiptHeaderProps, resolveLogoUrl(), splitRaisonSocialeLines(), buildFieldLine(), buildHeaderLegalHTML() (+7 more)

### Community 191 - "screen-skeleton.tsx"
Cohesion: 0.26
Nodes (9): AUTH_ERROR_MAP, extractErrorCode(), extractErrorMessage(), mapErrorToUserMessage(), PG_ERROR_MAP, RAW_MESSAGE_MAP, ToastFn, toastInfo() (+1 more)

## Knowledge Gaps
- **672 isolated node(s):** `supabase`, `supabase`, `$schema`, `style`, `rsc` (+667 more)
...
- **Why does `cn()` connect `dossier-bulk-import-dialog.tsx` to `devis.tsx`, `recu-paiement.ts`, `require-admin.ts`, `domain-types.ts`, `command-palette.tsx`, `export.ts`, `nav-store.ts`, `contrats.tsx`, `calendrier.tsx`, `command-palette.tsx`, `contrat-stats.test.ts`, `Facture`, `cn`, `dossier-form.tsx`, `informations-card.tsx`, `stock-slice.ts`, `csv-export.ts`, `dashboard-screen.tsx`, `getInitials`, `createServerClient`, `@radix-ui/react-slot`, `@radix-ui/react-toast`, `recharts`, `devis-detail-screen.tsx`, `dossiers-list-screen.tsx`, `bon-caisse-form-dialog.tsx`, `dossier-form-ui.tsx`, `screen-skeleton.tsx`, `require-admin.ts`, `operation-form-dialog.tsx`, `import-dialog.tsx`, `use-excel-workbook.ts`, `page.tsx`, `classeur-tab.tsx`, `facture.ts`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `comptabilite-generale-import.ts`, `tailwind-merge`, `recu-paiement.ts`, `@radix-ui/react-switch`, `@radix-ui/react-select`, `@radix-ui/react-label`, `package.json`, `bon-caisse.ts`, `@radix-ui/react-separator`, `@radix-ui/react-toast`, `server-only`, `@supabase/supabase-js`, `@radix-ui/react-alert-dialog`, `comptabilite-generale-import.ts`, `@radix-ui/react-dialog`, `tesseract.js`, `scripts`, `@radix-ui/react-dropdown-menu`, `exceljs`, `index.ts`, `ag-grid-react`, `excel-export.ts`, `heic2any`, `pdfjs-dist`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `react` connect `recu-paiement.ts` to `operation-form-dialog.tsx`, `@radix-ui/react-toast`, `page.tsx`, `contrat-stats.test.ts`, `dependencies`, `dashboard-screen.tsx`, `csv-export.ts`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
