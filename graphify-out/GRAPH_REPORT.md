...
## Corpus Check
- 618 files · ~812,006 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2489 nodes · 9341 edges · 182 communities (110 shown, 72 thin omitted)
...
Cohesion: 0.09
Nodes (40): ConvertDevisDialogProps, DevisActionsCard(), DevisRow, DossierRow, Devis, DevisInput, DevisStatut, DossierStatut (+32 more)

### Community 1 - "entreposage.tsx"
Cohesion: 0.13
Nodes (26): AuditAction, AuditEntry, AuditModule, AuditSourceRef, AuditSourceType, insertAuditLog(), resolveClientIp(), ArchiveRow (+18 more)

### Community 2 - "print-modules.ts"
Cohesion: 0.31
Nodes (25): htmlEscape(), acquirePrintTarget(), brandLogoImgHTML(), buildBrandSubHTML(), documentFooterHTML(), openPrintWindow(), platformFooterHTML(), triggerPrint() (+17 more)

### Community 3 - "store.ts"
Cohesion: 0.15
Nodes (26): syncFournisseurStats(), createContratsSlice(), mapContratFromDb(), mapContratPrestationFromDb(), mapDepenseFromDb(), fetchCoreEntities(), PagedFetchResult, buildSecondaryFetchSpecs() (+18 more)
...
Cohesion: 0.13
Nodes (25): CAPACITE_PRESETS, emptyTransporteurForm(), firstInvalidTransporteurStep(), isTransporteurFormValid(), isTransporteurStepValid(), maxReachableStep(), STEP_FIELDS, TRAJETS_SUGGERES (+17 more)

### Community 7 - "domain-types.ts"
Cohesion: 0.08
Nodes (36): REALTIME_TABLES, ContratFichierRow, ProfileRow, SocieteRow, ContratFichier, SocieteInput, User, ExcelWorkbook (+28 more)
...
Cohesion: 0.09
Nodes (53): BonCaisseTabProps, PreviewState, BonMarchandiseTabProps, BON_MOTIF_TONE, BON_MOTIFS, BON_STATUT_TONE, BonsTabProps, Phase (+45 more)
...
Cohesion: 0.11
Nodes (29): RolePicker(), allRoles, emptyFormState(), FormMode, FormTab, isCustomPermissionSet(), RoleFilter, roleMeta (+21 more)

### Community 13 - "contrats.tsx"
Cohesion: 0.16
Nodes (14): ClotureDialogProps, ImportAnyDialog(), ImportAnyDialogProps, isExcelFile(), ImportDialogProps, emptyForm(), FormState, OcrCaptureDialog() (+6 more)

### Community 15 - "dossier-wizard-steps.tsx"
Cohesion: 0.11
Nodes (28): EvolutionChartCard(), EvolutionChartCardProps, RecapClientCard(), RepartitionCard(), currentYearMonth(), getPeriodeLabel(), Periode, PERIODES (+20 more)

### Community 16 - "store-actions.test.ts"
Cohesion: 0.19
Nodes (11): DevisPipelineCard(), DevisNextStatut, DevisStatutConfig, NEXT_STATUT, STATUT_CONFIG, STATUT_FLOW, STATUTS_ALL, DevisStatutBadge() (+3 more)

### Community 17 - "contrat-stats.test.ts"
Cohesion: 0.14
Nodes (27): BonCaisseFormDialog(), BonCaisseTab(), BonFormDialog(), BonMarchandiseTab(), useBonFilters(), ClasseurGrid(), ClasseurGridProps, ComptabiliteGeneraleImportDialog() (+19 more)

### Community 18 - "contrat-fichiers-slice.ts"
Cohesion: 0.07
Nodes (41): EcrituresTableProps, NEXT_STATUT, STATUT_CONFIG, STATUT_FLOW, StatutCfg, STATUTS_ALL, PipelineCard(), VerticalStepper() (+33 more)
...
Cohesion: 0.15
Nodes (15): ConfirmActionDialog(), CreateDossierFromOcrButton(), DossiersListTable(), SORT_OPTIONS, SortKey, STATUT_OPTIONS, useDossiersListScreen(), FACTURE_TABS (+7 more)

### Community 21 - "cn"
Cohesion: 0.14
Nodes (23): ArchiveTab, DocSource, RattachementKind, TYPES_DOCUMENT, UnifiedDoc, useArchivesScreen(), useUnifiedDocs(), FournisseurFormModal() (+15 more)
...
Cohesion: 0.10
Nodes (19): DocumentMetaForm(), DocumentMetaValues, DocumentUploadFile, DocumentUploadZone(), useDossierDocumentsWarmup(), useActionConfirm(), Action, ActionType (+11 more)

### Community 25 - "dossier-form.tsx"
Cohesion: 0.12
Nodes (22): DETAIL_PARENT, NavSectionLabel(), Bone(), ScreenSkeleton(), LoginScreen(), useCanManageUsers(), useEffectivePermissionUser(), usePermissionsReady() (+14 more)
...
Cohesion: 0.13
Nodes (21): ClientFormFieldsProps, clientTypes, DevisFormProps, CATEGORIES, EntryExitDialogs(), SORTIE_MOTIFS, SortieMotif, EMPTY_LIGNE (+13 more)
...
Cohesion: 0.10
Nodes (33): DossierDetailDocuments(), FileDropZone(), SubDossierCard(), ActiveAnnexe, AnnexeRow, DossierFichierRow, MouvementRow, StockItemRow (+25 more)

### Community 31 - "ag-grid-community"
Cohesion: 0.21
Nodes (21): PATCH(), RouteContext, POST(), RouteContext, AdminClient, assertNotLastActiveAdmin(), DELETE(), PATCH() (+13 more)
...
Cohesion: 0.13
Nodes (16): PaymentInfoBanner(), PaymentInfoBannerProps, DEVIS_SORT_OPTIONS, DevisListFilters(), DevisSortKey, DocumentPreviewBody(), DocumentViewer(), FetchedDocumentPreview() (+8 more)

### Community 37 - "createServerClient"
Cohesion: 0.11
Nodes (20): RecapClientCardProps, RecapRow, SortDir, SortKey, SortableHead(), AmountRow(), DossierDetailOverview(), DossierInfoGrid() (+12 more)
...
Cohesion: 0.13
Nodes (17): ARCHIVE_COLUMNS, ArchiveUploadDialog(), TAB_META, TYPE_DOC_BADGE, ConfirmDeleteDialog(), ContratFileDropZone(), EntityFileDropZone(), EntityFileDropZoneLabels (+9 more)

### Community 40 - "@radix-ui/react-toast"
Cohesion: 0.23
Nodes (9): GrandLivreRow, buildEmptyWorkbookData(), GRAND_LIVRE_HEADERS, HEADER_STYLE, headerCellData(), buildGrandLivreXlsxBlob(), downloadBlob(), exportGrandLivreToXlsx() (+1 more)
...
Cohesion: 0.08
Nodes (40): react, react, ChartPayloadItem, ChartTooltip(), PiePayloadItem, PieTooltip(), beneficiairesSummary(), CaisseMobileCard() (+32 more)

### Community 46 - "parametres.tsx"
Cohesion: 0.10
Nodes (11): PieDatum, RepartitionCardProps, DossiersEvolutionChart(), InfoRow(), PaymentRing(), CardAction(), CardContent(), CardDescription() (+3 more)
...
Cohesion: 0.13
Nodes (27): CollapsibleSection(), SectionTitle(), SummaryRow(), toneMap, DossierIdentityStep(), DossierIdentityStepProps, DossierSuiviSection(), DossierSuiviSectionProps (+19 more)
...
Cohesion: 0.22
Nodes (15): PendingConfirm, UseExcelWorkbookParams, planClasseurImport(), excelTheme, cellToNumber(), cellToString(), ecritureClasseurReference(), injectGrandLivre() (+7 more)
...
Cohesion: 0.23
Nodes (13): RecuReceiptBody(), RecuReceiptBodyProps, buildFieldLine(), buildHeaderLegalHTML(), buildRecuPaiementHTML(), buildSignatureHTML(), fmtDate(), montantEnLettresFCFA() (+5 more)
...
Cohesion: 0.09
Nodes (33): ClientFormFields(), today(), useEcrituresScreen(), ConvertDevisDialog(), DevisFormDialog(), DevisListBanner(), DevisListKpis(), DevisListTable() (+25 more)

### Community 101 - "operation-form-dialog.tsx"
Cohesion: 0.12
Nodes (15): EcrituresFilters(), EcrituresFiltersProps, NewEcritureDialog(), NewEcritureDialogProps, PaymentDialogProps, modeOptions, StatutFilter, CONTRAT_STATUT_TONE (+7 more)
...
Cohesion: 0.06
Nodes (51): AnnexeSelector(), StatPill(), Heading(), Heading(), AdminPanel(), InfoRow(), StatPill(), DossierDetailHero() (+43 more)
...
Cohesion: 0.24
Nodes (9): ClasseurTab(), ClasseurTabProps, ClasseurViewMode, classeurStatutTone(), ExcelWorkbookLazy(), ExcelWorkbookPanel, ClasseurEntry, ClasseurFilters (+1 more)

### Community 117 - "contrat-detail.tsx"
Cohesion: 0.20
Nodes (25): BonCaisseFormDialogProps, CaisseLigneForm, BonFormDialogProps, ClasseurSuiviDialogProps, CheckedState, Phase, ReviewRow, StatutHistorique (+17 more)
...
Cohesion: 0.27
Nodes (7): entiteKeyOf(), EntitesConsolideesCard(), OperationsKpiRow(), OperationsKpiRowProps, OperationsTable(), Badge(), badgeVariants

### Community 126 - "ocr-capture-dialog.tsx"
Cohesion: 0.06
Nodes (55): deriveClientIdFromRattachement(), RattachementKind, syncContratStats(), BaseContrat, BonSortieCaisseLigneRow, BonSortieStatut, ClientRow, ContratPrestationRow (+47 more)
...
Cohesion: 0.23
Nodes (9): DangerConfirmDialog(), changePasswordBodySchema, createUserBodySchema, updateUserBodySchema, BackupRestorePayload, backupRestoreSchema, operationImportRowSchema, operationImportRowsSchema (+1 more)

### Community 132 - "shared.tsx"
Cohesion: 0.17
Nodes (16): mapAuditLogFromDb(), buildClasseurJournal(), buildDossierLibelle(), classeurEntrySourceType(), ClasseurMouvementRow, ClasseurType, computeClasseurTotals(), fetchClasseurMouvements() (+8 more)

### Community 133 - "contrats.tsx"
Cohesion: 0.11
Nodes (22): AgentPanel(), MagasinierPanel(), StockRepartitionChart(), CalendrierScreen(), CalEvent, DayPanel(), daysInMonth(), EventType (+14 more)
...
Cohesion: 0.12
Nodes (22): BeforeInstallPromptEvent, InstallPWA(), InstallPWAProps, isDesktopChromium(), isIos(), isStandalone(), Benefice, BeneficeKpiRowProps (+14 more)
...
### Community 152 - "bon-caisse.ts"
Cohesion: 0.36
Nodes (8): buildLegalLine(), buildPrintDocument(), printHTMLLogoImg(), resolveLogoUrl(), BonSortieCaisseModuleData, buildBonSortieCaisseHTML(), printBonSortieCaisseModule(), SocieteLegalInfo
...
Cohesion: 0.07
Nodes (28): inter, metadata, sora, viewport, PwaGlobalEffects(), PwaUpdatePrompt(), AppSerwistProvider(), ACTIVITY_EVENTS (+20 more)
...
### Community 164 - "confirm-transitions.ts"
Cohesion: 0.60
...
Cohesion: 0.07
Nodes (37): AlertesCard(), ChartTooltipPayload, EcartsTooltip(), EncaissementsTooltip(), DerniersDossiersCard(), EncaissementsChart(), MargeChart(), useDashboardMetrics() (+29 more)

### Community 172 - "guide-progress.ts"
Cohesion: 0.29
Nodes (8): emitGuideReset(), getGuideProgress(), getGuideStepsForRole(), GUIDE_STEP_DEFS, GuideStepId, GuideStepView, GuideStoreSnapshot, isGuideStepComplete()

### Community 176 - "InstallPWA.tsx"
Cohesion: 0.14
Nodes (36): OfflineIndicator(), emptyClientForm(), OcrReviewDialog(), useDossierFormActions(), AppShell(), BreadcrumbNav(), CommandPalette(), Sidebar() (+28 more)

### Community 180 - "page.tsx"
Cohesion: 0.12
Nodes (18): BonsTab(), ClientProfileCard(), ClientProfileCardProps, avatarGradient(), BON_MOTIF_TONE, bonStatutTone(), CLASSEUR_STATUT_TONE, FICHE_TABS (+10 more)
...
- **Why does `cn()` connect `dossier-bulk-import-dialog.tsx` to `require-admin.ts`, `contrats.tsx`, `dossier-amounts-section.tsx`, `utils.ts`, `export.ts`, `nav-store.ts`, `contrats.tsx`, `command-palette.tsx`, `dossier-wizard-steps.tsx`, `store-actions.test.ts`, `contrat-stats.test.ts`, `Facture`, `cn`, `archives-slice.ts`, `dossier-form.tsx`, `UserRole`, `dossier-detail-stepper.tsx`, `class-variance-authority`, `comptabilite-generale-import.ts`, `createServerClient`, `@radix-ui/react-slot`, `@radix-ui/react-dropdown-menu`, `recharts`, `guide-progress.ts`, `operation-form-dialog.tsx`, `parametres.tsx`, `InstallPWA.tsx`, `archives-slice.ts`, `page.tsx`, `dashboard-metrics.ts`, `require-admin.ts`, `contrats.tsx`, `classeur-tab.tsx`, `contrat-detail.tsx`, `dossier-detail-overview.tsx`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `react` connect `operation-form-dialog.tsx` to `contrats.tsx`, `InstallPWA.tsx`, `contrat-stats.test.ts`, `Facture`, `cn`, `dependencies`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `tailwind-merge`, `@radix-ui/react-switch`, `@radix-ui/react-select`, `calendrier.tsx`, `@radix-ui/react-label`, `package.json`, `next`, `@radix-ui/react-separator`, `classeur.ts`, `@radix-ui/react-toast`, `server-only`, `@radix-ui/react-alert-dialog`, `@supabase/supabase-js`, `@radix-ui/react-dialog`, `serwist`, `tesseract.js`, `@univerjs/preset-sheets-core`, `operation-form-dialog.tsx`, `recap-client-card.tsx`, `@radix-ui/react-dropdown-menu`, `cmdk`, `page.tsx`, `excel-export.ts`, `heic2any`, `pdfjs-dist`?**
