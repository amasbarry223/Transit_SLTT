...
## Corpus Check
- 718 files · ~302,975 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2629 nodes · 9981 edges · 178 communities (105 shown, 73 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 51 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d202ebd7`
...
## Communities (178 total, 73 thin omitted)

### Community 0 - "devis.tsx"
Cohesion: 0.12
Nodes (20): ConfirmActionDialog(), ConvertDevisDialog(), DevisActionsCard(), DevisEditForm(), DevisListBanner(), DevisListFilters(), DevisSortKey, DevisDetailScreen() (+12 more)

### Community 1 - "entreposage.tsx"
Cohesion: 0.10
Nodes (28): ACTIVITY_EVENTS, AppRootInner(), LoginScreen(), SupabaseRequiredScreen(), fetchWithAuth(), resolveAccessToken(), ProfileRow, User (+20 more)
...
Cohesion: 0.10
Nodes (35): mapClientFromDb(), ProfilePublicRow, mapAnnexeFromDb(), fetchCoreEntities(), PagedFetchResult, buildSecondaryFetchSpecs(), fetchSecondaryEntities(), SECONDARY_FETCH_KEYS (+27 more)
...
Cohesion: 0.12
Nodes (25): ClotureDialog(), dayAfter(), firstDayOfMonth(), today(), EntiteTotal, JournalCaissePanelProps, OperationRowProps, OperationsTableProps (+17 more)

### Community 6 - "utils.ts"
Cohesion: 0.12
Nodes (33): numStr(), useDossierFormState(), UseDossierFormStateOptions, DossierRow, resteAPayer(), DossierStatut, FactureLigne, computeIncrementalPaye() (+25 more)

### Community 7 - "domain-types.ts"
Cohesion: 0.09
Nodes (29): ChartPayloadItem, ChartTooltip(), PiePayloadItem, PieTooltip(), EvolutionChartCard(), EvolutionChartCardProps, PieDatum, RepartitionCard() (+21 more)
...
Cohesion: 0.13
Nodes (29): DevisFormDialog(), DEVIS_SORT_OPTIONS, CATEGORIES, PAIEMENT_MODES, TransitionDialogProps, StockMovementFields(), StockMovementFieldsProps, clientTypes (+21 more)

### Community 10 - "useStore"
Cohesion: 0.09
Nodes (26): FactureRowProps, RattachementKind, syncClientStats(), DepenseRow, EcritureRow, Archive, Dossier, Ecriture (+18 more)

### Community 12 - "nav-store.ts"
Cohesion: 0.11
Nodes (21): NEXT_STATUT, STATUT_CONFIG, STATUT_FLOW, StatutCfg, STATUTS_ALL, PipelineCard(), VerticalStepper(), FACTURE_TABS (+13 more)

### Community 13 - "contrats.tsx"
Cohesion: 0.10
Nodes (41): RecapClientCard(), RecapRow, SortableHead(), actionTone, ResponsiveDataListProps, DEVIS_STATUT_TONE, DOSSIER_STATUT_TONE, dotClasses (+33 more)

### Community 14 - "calendrier.tsx"
Cohesion: 0.08
Nodes (28): EmptyState(), EmptyStateAction, ListFiltersProps, UsersEmptyState(), EcritureStatutBadge(), FactureStatutBadge(), StockStatutBadge(), TablePagination() (+20 more)

### Community 15 - "dossier-wizard-steps.tsx"
Cohesion: 0.10
Nodes (40): syncContratStats(), BaseContrat, ClotureCaisseRow, ContratRow, OperationComptableRow, ClotureCaisse, Contrat, ContratInput (+32 more)

### Community 16 - "store-actions.test.ts"
Cohesion: 0.28
Nodes (11): ConvertDevisDialogProps, DevisFormProps, mapDevisFromDb(), Devis, DevisInput, DevisListPrintRow, DevisStatut, DevisRow (+3 more)
...
Cohesion: 0.09
Nodes (27): EvolutionChartCardImpl, EvolutionChartCardLazy(), DossierDetailSuivi(), DossierInfoGrid(), InfoTile(), ListFilters(), BonPreview(), ClasseurGridImpl (+19 more)

### Community 21 - "cn"
Cohesion: 0.10
Nodes (27): ConfirmDeleteDialog(), FilterChip, MetaTabItem, MetaTabsList(), ResponsiveColumn, ARCHIVE_COLUMNS, ArchivesScreen(), ArchiveTab (+19 more)
...
Cohesion: 0.20
Nodes (10): DEFAULT_PAIEMENT_MODE, DOSSIER_STATUT_DEDOUANE, DOSSIER_STATUT_EN_COURS, DOSSIER_STATUT_SOLDE, FETCH_ENTITY_SOFT_CAPS, getRecoveryRateColor(), RECOVERY_RATE_THRESHOLDS, DOC_ACCEPTED_MIME_TYPES (+2 more)
...
Cohesion: 0.06
Nodes (74): PATCH(), RouteContext, POST(), RouteContext, AdminClient, assertNotLastActiveAdmin(), DELETE(), PATCH() (+66 more)

### Community 30 - "csv-export.ts"
Cohesion: 0.08
Nodes (45): DossierBulkImportButton(), PageHeader(), BonCaisseFormDialog(), BonCaisseTab(), BonFormDialog(), BonMarchandiseTab(), BonsScreen(), useBonFilters() (+37 more)

### Community 31 - "ag-grid-community"
Cohesion: 0.32
Nodes (9): useDashboardMetrics(), DOSSIER_STATUT_HEX, buildDossiersParMois(), buildLiveAlertes(), buildStockRepartition(), computeEncaisseVariation(), computeRestesAPayer(), DASHBOARD_CHART_MONTHS (+1 more)

### Community 32 - "classeur.ts"
Cohesion: 0.23
Nodes (32): printClients(), DevisData, DevisListPrintRow, fmtDevisDate(), fmtDevisDateShort(), prestataireDisplayName(), printDevis(), printDevisList() (+24 more)
...
Cohesion: 0.24
Nodes (12): ClientFormFields(), emptyClientForm(), ClientsScreen(), ClientsTable(), Props, QuickClientButton(), avatarGradient(), ClientSortKey (+4 more)
...
Cohesion: 0.09
Nodes (36): OfflineIndicator(), CreateDossierFromOcrButton(), emptyForm(), OcrReviewActions(), OcrReviewDialog(), OcrReviewFields(), useOcrReviewState(), getNextTransition() (+28 more)

### Community 40 - "@radix-ui/react-toast"
Cohesion: 0.27
Nodes (10): DEFAULT_ACCEPTED_MIME_PREFIXES, DEFAULT_ACCEPTED_MIME_TYPES, EntityFileDropZone(), EntityFileDropZoneLabels, EntityFileItem, EntityFilePayload, isAcceptedFileType(), formatFileSize() (+2 more)

### Community 41 - "recharts"
Cohesion: 0.19
Nodes (17): BilanPrintRow, BilanPrintTotals, ClasseurPrintRow, ClasseurPrintTotals, printClasseur(), statutTone(), typeBadgeClass(), FactureModuleData (+9 more)
...
Cohesion: 0.30
Nodes (8): TransporteursTable(), TransporteursTableProps, InlineFormState, SORT_OPTIONS, SortKey, useTransporteursScreen(), TransporteursScreen(), useDeleteConfirm()

### Community 45 - "ag-grid-community"
Cohesion: 0.16
Nodes (12): AmountRow(), DossierDetailOverview(), TRANSITION_META, TransitionDialog(), TransitionType, GlossaryLabel(), EcartValue(), DossierMobileCard (+4 more)

### Community 46 - "ecritures-panel.tsx"
Cohesion: 0.18
Nodes (14): FactureDocumentHeader(), BonSortieCaisseModuleData, ANNEXE_DOSSIER_COUT_LABELS, DEFAULT_DOSSIER_COUT_LABELS, DossierCoutLabels, formatSocieteLegalLine(), hasSocieteLogo(), PrintHTMLBrand (+6 more)

### Community 47 - "guide-progress.ts"
Cohesion: 0.13
Nodes (25): AuditAction, AuditModule, AuditSourceRef, insertAuditLog(), resolveClientIp(), ArchiveRow, ARCHIVES_ALLOWED_MIME, createArchivesSlice() (+17 more)
...
Cohesion: 0.08
Nodes (45): DossierDetailDocuments(), FileDropZone(), SubDossierCard(), ClientFormFieldsProps, AnnexeRow, ContratFichierRow, MouvementRow, SocieteRow (+37 more)
...
Cohesion: 0.12
Nodes (20): DevisListKpis(), InfoCallout(), iconWrap, KpiCard(), KpiTone, SocieteBadge(), SocieteFilterSelect(), beneficiairesSummary() (+12 more)
...
Cohesion: 0.27
Nodes (8): AgentPanel(), AlertesCard(), MagasinierPanel(), DashboardSection, getDashboardSections(), kpiGridClass(), SECTION_PERMISSIONS, LiveAlert
...
Cohesion: 0.10
Nodes (30): react, react, DocumentMetaForm(), DocumentMetaValues, DocumentUploadFile, DocumentUploadZone(), DossierDocumentsPanel(), useDossierDocumentsWarmup() (+22 more)

### Community 101 - "operation-form-dialog.tsx"
Cohesion: 0.10
Nodes (35): FIELD_LABELS, FormState, OcrReviewState, OcrReviewStateProps, BonCaisseFormDialogProps, CaisseLigneForm, ClotureDialogProps, ImportAnyDialog() (+27 more)
...
Cohesion: 0.06
Nodes (51): AdminPanel(), DevisListTable(), DevisPipelineCard(), DevisNextStatut, DevisStatutConfig, NEXT_STATUT, STATUT_CONFIG, STATUT_FLOW (+43 more)

### Community 107 - "use-excel-workbook.ts"
Cohesion: 0.11
Nodes (23): ExcelWorkbookPanel, ClientFicheScreen(), AuditSourceType, mapAuditLogFromDb(), buildClasseurJournal(), buildDossierLibelle(), ClasseurEntry, classeurEntrySourceType() (+15 more)
...
Cohesion: 0.07
Nodes (48): BonSortieCaisseLigneRow, BonSortieCaisseRow, BonSortieRow, BonSortieStatut, ContratPrestationRow, DossierFichierRow, DossierFournisseurRow, DossierFournisseurStatut (+40 more)

### Community 116 - "classeur-tab.tsx"
Cohesion: 0.12
Nodes (14): ActifStatutBadge(), DossierFournisseurStatutBadge(), CoutRow, PaginationProps, PrestataireRow, TarifRow, TypeBadge(), ResteSummary() (+6 more)

### Community 117 - "InstallPWA.tsx"
Cohesion: 0.14
Nodes (17): BeforeInstallPromptEvent, InstallPWA(), InstallPWAProps, isDesktopChromium(), isIos(), isStandalone(), CheckedState, Phase (+9 more)
...
Cohesion: 0.40
Nodes (4): FormField(), StepId, STEPS, toneMap

### Community 126 - "facture.ts"
Cohesion: 0.14
Nodes (23): buildRecuPrintData(), printRecu(), printRecuFromForm(), RecuFormModuleInput, resolveGeneratorBrand(), resolveRecuBrand(), toRecuModuleData(), buildFieldLine() (+15 more)
...
Cohesion: 0.19
Nodes (17): RecapClientCardProps, currentYearMonth(), getPeriodeLabel(), Periode, PERIODES, SortDir, SortKey, useBilansScreen() (+9 more)
...
Cohesion: 0.17
Nodes (18): AnnexeSelector(), DETAIL_PARENT, NavList(), NavSectionLabel(), SidebarBrand(), viewTitles, pathForView(), NavItem (+10 more)

### Community 140 - "command-palette.tsx"
Cohesion: 0.10
Nodes (28): RecuGeneratorActions(), RecuGeneratorForm(), RecuGeneratorFormProps, FieldLine(), RecuReceiptBody(), RecuReceiptBodyProps, RecuReceiptHeader(), RecuReceiptHeaderProps (+20 more)
...
Cohesion: 0.08
Nodes (37): extractClientIp(), GET(), CLIENT_TYPES, clientInputSchema, ClientInputValidated, mapClientInputToDb(), clientService, createClient() (+29 more)
...
Cohesion: 0.23
Nodes (8): RepartitionCardImpl, RepartitionCardLazy(), DossiersEvolutionChartImpl, DossiersEvolutionChartLazy(), StockRepartitionChartImpl, StockRepartitionChartLazy(), importWithRetry(), isRetriableChunkError()
...
Cohesion: 0.12
Nodes (28): LOGO_ACCEPTED_TYPES, SocieteCard(), ClasseurGrid(), ClasseurGridProps, ContratFileDropZone(), ContratDetailScreen(), contratToInput(), DossierFormState (+20 more)

### Community 183 - "bon-caisse-form-dialog.tsx"
Cohesion: 0.17
Nodes (18): DangerConfirmDialog(), OcrReviewDialogImpl, OcrReviewDialogLazy(), BonFormDialogProps, RecuGeneratorActionsProps, calculateDaysUntil(), isEcheanceDepassee(), isEcheanceImminente() (+10 more)
...
## Knowledge Gaps
- **588 isolated node(s):** `supabase`, `supabase`, `$schema`, `style`, `rsc` (+583 more)
...
- **Why does `cn()` connect `dossier-bulk-import-dialog.tsx` to `devis.tsx`, `require-admin.ts`, `domain-types.ts`, `command-palette.tsx`, `export.ts`, `sync-sequences.ts`, `command-palette.tsx`, `contrats.tsx`, `calendrier.tsx`, `contrat-stats.test.ts`, `Facture`, `cn`, `dossier-form.tsx`, `informations-card.tsx`, `stock-slice.ts`, `csv-export.ts`, `comptabilite-generale-import.ts`, `getInitials`, `2. Fonctionnalités demandées`, `@radix-ui/react-slot`, `@radix-ui/react-toast`, `createServerClient`, `SLTT — Retour client V1 : Classeur Client & Architecture Bi-Sociétés`, `ag-grid-community`, `use-recu-generator.ts`, `bon-caisse-form-dialog.tsx`, `dashboard-metrics.ts`, `use-permission.ts`, `dossier-form-ui.tsx`, `calculations.test.ts`, `operation-form-dialog.tsx`, `users-slice.ts`, `use-excel-workbook.ts`, `classeur-tab.tsx`, `InstallPWA.tsx`, `classeur-grid-lazy.tsx`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `comptabilite-generale-import.ts`, `zod`, `tailwind-merge`, `@radix-ui/react-switch`, `@radix-ui/react-select`, `@radix-ui/react-label`, `package.json`, `bon-caisse.ts`, `ag-grid-community`, `@radix-ui/react-separator`, `@radix-ui/react-toast`, `server-only`, `@supabase/supabase-js`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-dialog`, `tesseract.js`, `scripts`, `@radix-ui/react-dropdown-menu`, `exceljs`, `calculations.test.ts`, `require-admin.ts`, `excel-export.ts`, `heic2any`, `pdfjs-dist`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `react` connect `calculations.test.ts` to `devis.tsx`, `2. Fonctionnalités demandées`, `contrat-stats.test.ts`, `dependencies`, `csv-export.ts`?**
