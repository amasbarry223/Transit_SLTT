# Graph Report - Transit_SLTT  (2026-08-11)

## Corpus Check
- 532 files · ~780,155 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2221 nodes · 8281 edges · 152 communities (82 shown, 70 thin omitted)
...
1. `cn()` - 279 edges
2. `formatFCFA()` - 144 edges
3. `useStore` - 143 edges
4. `useToast()` - 109 edges
5. `Button()` - 99 edges
6. `formatDateShort()` - 77 edges
7. `Card()` - 74 edges
8. `usePermission()` - 61 edges
9. `Input()` - 53 edges
10. `useNav` - 49 edges
...
Cohesion: 0.18
Nodes (13): ClientFormFieldsProps, NewEcritureDialogProps, SocieteRow, Client, Societe, SocieteInput, societe(), ClientInput (+5 more)

### Community 1 - "entreposage.tsx"
Cohesion: 0.07
Nodes (48): ConvertDevisDialogProps, DevisFormProps, NEXT_STATUT, STATUT_CONFIG, STATUT_FLOW, StatutCfg, STATUTS_ALL, PipelineCard() (+40 more)

### Community 2 - "print-modules.ts"
Cohesion: 0.07
Nodes (78): inter, metadata, sora, viewport, AppRoot(), FactureDocumentHeader(), ThemeEffect(), Toast (+70 more)

### Community 3 - "store.ts"
Cohesion: 0.17
Nodes (16): REALTIME_TABLES, fetchWithAuth(), User, ExcelWorkbook, ExcelWorkbookRow, LOGGED_OUT, createExcelWorkbooksSlice(), currentUserId() (+8 more)

### Community 4 - "dossiers-slice.ts"
Cohesion: 0.15
Nodes (16): Action, ActionType, actionTypes, addToRemoveQueue(), dispatch(), genId(), listeners, memoryState (+8 more)

### Community 5 - "require-admin.ts"
Cohesion: 0.14
Nodes (22): ClotureDialog(), dayAfter(), firstDayOfMonth(), today(), EntiteTotal, OperationsTableProps, NATURE_SUGGESTIONS, entiteKeyOf() (+14 more)

### Community 6 - "utils.ts"
Cohesion: 0.05
Nodes (78): PATCH(), RouteContext, POST(), RouteContext, AdminClient, assertNotLastActiveAdmin(), DELETE(), PATCH() (+70 more)

### Community 7 - "domain-types.ts"
Cohesion: 0.09
Nodes (39): syncContratStats(), ClotureCaisseRow, OperationComptableRow, ClotureCaisse, EntiteComptableType, OperationComptableInput, mapAnnexeFromDb(), ComptabiliteGeneraleSlice (+31 more)
...
Cohesion: 0.16
Nodes (27): BonsTabProps, DossiersTabProps, FacturesTabProps, TabEmptyState(), StockTabProps, EcrituresTableProps, Heading(), entiteKeyOf() (+19 more)
...
Cohesion: 0.15
Nodes (24): BonCaisseFormDialogProps, CaisseLigneForm, Phase, ReviewRow, ClotureDialogProps, ImportAnyDialog(), ImportAnyDialogProps, isExcelFile() (+16 more)

### Community 13 - "contrats.tsx"
Cohesion: 0.17
Nodes (25): ClientFormFields(), clientTypes, modeOptions, DevisFormDialog(), DEVIS_SORT_OPTIONS, CATEGORIES, CheckedState, Phase (+17 more)

### Community 15 - "dossier-wizard-steps.tsx"
Cohesion: 0.25
Nodes (10): ClasseurSuiviDialog(), ClasseurSuiviDialogProps, ClasseurTab(), ClasseurTabProps, ClasseurViewMode, classeurStatutTone(), ExcelWorkbookLazy(), ExcelWorkbookPanel (+2 more)

### Community 16 - "store-actions.test.ts"
Cohesion: 0.08
Nodes (40): react, react, BonCaisseTab(), BonFormDialog(), ClasseurGrid(), ClasseurGridProps, ClasseurImportDialog(), ComptabiliteGeneraleImportDialog() (+32 more)

### Community 17 - "contrat-stats.test.ts"
Cohesion: 0.13
Nodes (34): AnnexeSelector(), BonCaisseFormDialog(), CreateDossierFromOcrButton(), DossierBulkImportButton(), DossierDocumentsPanel(), emptyForm(), OcrReviewDialog(), ExcelWorkbookPanel() (+26 more)

### Community 18 - "contrat-fichiers-slice.ts"
Cohesion: 0.10
Nodes (34): PaymentDialogProps, TransitionDialogProps, deriveClientIdFromRattachement(), RattachementKind, syncClientStats(), DepenseRow, DossierRow, EcritureRow (+26 more)
...
### Community 21 - "cn"
Cohesion: 0.10
Nodes (21): ConvertDevisDialog(), DevisEditForm(), DevisListBanner(), DevisListFilters(), DevisSortKey, InfoRow(), EntryExitDialogs(), StockTab() (+13 more)

### Community 22 - "dependencies"
Cohesion: 0.08
Nodes (25): ag-grid-community, class-variance-authority, clsx, lucide-react, dependencies, ag-grid-community, class-variance-authority, clsx (+17 more)
...
Cohesion: 0.33
Nodes (11): FactureEditForm(), AlertDialog(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent(), AlertDialogDescription(), AlertDialogFooter(), AlertDialogHeader() (+3 more)

### Community 25 - "dossier-form.tsx"
Cohesion: 0.14
Nodes (16): BonMarchandiseTab(), BonMarchandiseTabProps, BON_MOTIF_TONE, BON_MOTIFS, BON_STATUT_TONE, useBonFilters(), EmptyState(), EMPTY_LIGNE (+8 more)
...
Cohesion: 0.09
Nodes (33): DossierDetailOverview(), DossierAmountsSection(), DossierAmountsSectionProps, CollapsibleSection(), SectionTitle(), SummaryRow(), toneMap, DossierIdentityStep() (+25 more)
...
Cohesion: 0.13
Nodes (28): ContratFichierRow, DocumentRow, buildDocumentStoragePath(), dataUrlToBlob(), getSignedDocumentUrl(), removeDocumentStoragePaths(), sha256Hex(), uploadDocumentBlob() (+20 more)

### Community 30 - "csv-export.ts"
Cohesion: 0.12
Nodes (20): ClientProfileCard(), ClientProfileCardProps, avatarGradient(), BON_MOTIF_TONE, bonStatutTone(), CLASSEUR_STATUT_TONE, FICHE_TABS, FicheTab (+12 more)

### Community 31 - "ag-grid-community"
Cohesion: 0.14
Nodes (12): PaymentInfoBanner(), PaymentInfoBannerProps, DocumentViewer(), isDirectUrl(), FIELD_LABELS, FormState, LOGO_ACCEPTED_TYPES, SocieteCard() (+4 more)
...
Cohesion: 0.05
Nodes (47): AdminPanel(), AgentPanel(), AlertesCard(), DossiersEvolutionChart(), GuideDemarrage(), MagasinierPanel(), useDashboardMetrics(), DOSSIER_STATUT_HEX (+39 more)
...
Cohesion: 0.15
Nodes (12): ConfirmDeleteDialog(), DocumentMetaForm(), DocumentMetaValues, DocumentUploadFile, DocumentUploadZone(), EntityFileDropZone(), EntityFileDropZoneLabels, EntityFileItem (+4 more)

### Community 40 - "@radix-ui/react-toast"
Cohesion: 0.20
Nodes (12): ChartTooltipPayload, EcartsTooltip(), EncaissementsTooltip(), DerniersDossiersCard(), EncaissementsChart(), MargeChart(), DOSSIER_STATUT_DOT, DossierStatutBadge() (+4 more)

### Community 41 - "recharts"
Cohesion: 0.16
Nodes (12): ACTIVITY_EVENTS, AppRootInner(), useSupabaseRealtime(), clearLegacyNavPersist(), LegacyNavPersist, readLegacyNavPersist(), seedFromLegacy(), CurrencyLabel (+4 more)
...
Cohesion: 0.09
Nodes (22): AmountRow(), DossierInfoGrid(), InfoTile(), TRANSITION_META, TransitionType, GlossaryLabel(), ChartPayloadItem, ChartTooltip() (+14 more)

### Community 46 - "parametres.tsx"
Cohesion: 0.05
Nodes (64): ConfirmActionDialog(), ExcelSaveStatus, ExcelToolbar(), QuickBtn(), ExcelWorkbookPanelProps, AuditSourceType, mapAuditLogFromDb(), buildClasseurJournal() (+56 more)

### Community 47 - "guide-progress.ts"
Cohesion: 0.12
Nodes (23): EcrituresFilters(), NewEcritureDialog(), PaymentDialog(), FilterChip, ListFilters(), ListFiltersProps, MetaTabItem, MetaTabsList() (+15 more)
...
Cohesion: 0.26
Nodes (9): BonFormDialogProps, emptyClientForm(), Props, QuickClientButton(), Badge(), badgeVariants, toastError(), ToastFn (+1 more)

### Community 57 - "dashboard-metrics.ts"
Cohesion: 0.12
Nodes (32): BaseContrat, AnnexeRow, ContratRow, MouvementRow, StockItemRow, Annexe, AnnexeInput, Archive (+24 more)
...
Cohesion: 0.18
Nodes (13): DossierDetailDocuments(), FileDropZone(), SubDossierCard(), DossierFichierRow, SubDossierRow, DossierFichier, SubDossier, baseClient (+5 more)
...
Cohesion: 0.15
Nodes (31): AppShell(), BreadcrumbNav(), DETAIL_PARENT, CommandPalette(), NavList(), Sidebar(), Topbar(), viewTitles (+23 more)

### Community 104 - "contrats.tsx"
Cohesion: 0.20
Nodes (12): ContratFileDropZone(), ContratFormModal(), DepenseFormModal(), PrestationFormModal(), CONTRAT_STATUT_TONE, CONTRAT_STATUTS, contratToInput(), InfoRow() (+4 more)

### Community 105 - "dossier-bulk-import-dialog.tsx"
Cohesion: 0.05
Nodes (40): StatPill(), StatPill(), Heading(), DevisActionsCard(), DocumentPreviewBody(), FetchedDocumentPreview(), StatPill(), NewItemDialog() (+32 more)
...
Cohesion: 0.17
Nodes (22): SORT_OPTIONS, SortKey, TransporteurFormModal(), ActifStatutBadge(), CAPACITE_PRESETS, emptyTransporteurForm(), firstInvalidTransporteurStep(), isTransporteurFormValid() (+14 more)

### Community 108 - "devis-slice.ts"
Cohesion: 0.26
Nodes (10): EcrituresFiltersProps, deriveStatut(), modeIcon, StatutFilter, today(), useEcrituresScreen(), ComptablePanel(), TransitionDialog() (+2 more)

### Community 116 - "use-benefice-par-societe.ts"
Cohesion: 0.07
Nodes (41): beneficiairesSummary(), BonCaisseTabProps, CaisseMobileCard(), CaisseTableRow(), PreviewState, BonPreview(), BonMobileCard(), BonTableRow() (+33 more)
...
### Community 126 - "command-palette.tsx"
Cohesion: 0.31
...
### Community 132 - "cmdk"
Cohesion: 0.08
Nodes (43): BonSortieCaisseLigneRow, BonSortieStatut, ClientRow, ContratPrestationRow, DocumentVersionRow, DossierFournisseurRow, DossierFournisseurStatut, FactureLigneRow (+35 more)
...
Cohesion: 0.18
Nodes (20): UnifiedDoc, AuditAction, AuditEntry, AuditModule, AuditSourceRef, insertAuditLog(), resolveClientIp(), ArchiveRow (+12 more)
...
## Knowledge Gaps
- **571 isolated node(s):** `supabase`, `supabase`, `$schema`, `style`, `rsc` (+566 more)
...
- **Why does `dependencies` connect `dependencies` to `@radix-ui/react-toast`, `tailwind-merge`, `@radix-ui/react-switch`, `recharts`, `@radix-ui/react-select`, `calendrier.tsx`, `cmdk`, `store-actions.test.ts`, `@radix-ui/react-label`, `tailwindcss-animate`, `ag-grid-react`, `next`, `@radix-ui/react-separator`, `classeur.ts`, `@radix-ui/react-toast`, `server-only`, `@supabase/supabase-js`, `scripts`, `archives-slice.ts`, `sync-sequences.ts`, `excel-export.ts`, `contrat-detail.tsx`, `heic2any`, `pdfjs-dist`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `react` connect `store-actions.test.ts` to `require-admin.ts`, `derniers-dossiers-card.tsx`, `contrat-stats.test.ts`, `cn`, `dependencies`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `cn()` connect `dossier-bulk-import-dialog.tsx` to `entreposage.tsx`, `print-modules.ts`, `require-admin.ts`, `utils.ts`, `export.ts`, `nav-store.ts`, `contrats.tsx`, `dossier-wizard-steps.tsx`, `store-actions.test.ts`, `contrat-stats.test.ts`, `Facture`, `cn`, `archives-slice.ts`, `dossier-form.tsx`, `domain-types.ts`, `csv-export.ts`, `ag-grid-community`, `derniers-dossiers-card.tsx`, `@radix-ui/react-slot`, `@radix-ui/react-toast`, `operation-form-dialog.tsx`, `parametres.tsx`, `guide-progress.ts`, `factures.tsx`, `require-admin.ts`, `@radix-ui/react-avatar`, `contrats.tsx`, `status-badge.tsx`, `devis-slice.ts`, `use-benefice-par-societe.ts`, `command-palette.tsx`?**
