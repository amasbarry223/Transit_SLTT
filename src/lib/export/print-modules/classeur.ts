...
.doc-title { font-size: 26px; font-weight: 800; color: ${BRAND.navy}; letter-spacing: -1px; line-height: 1.1; }
...
.kpi-val { font-size: 20px; font-weight: 800; color: ${BRAND.navy}; line-height: 1; }
