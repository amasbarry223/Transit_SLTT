    ...
    <div className="space-y-4">
      ...
      <Card className="gap-0 overflow-hidden p-0 shadow-sm border-border/80">
        {filtered.length === 0 ? (
          <EmptyState
            icon={History}
            title={mouvements.length === 0 ? UI.empty.mouvements.zero.title : UI.empty.mouvements.filtered.title}
            description={mouvements.length === 0 ? UI.empty.mouvements.zero.description : UI.empty.mouvements.filtered.description}
          />
        ) : (
          <>
