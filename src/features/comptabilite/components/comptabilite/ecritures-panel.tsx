...
import { BeneficeKpiRow } from "./benefice-kpi-row";
import { EcrituresFilters } from "./ecritures-filters";
import { EcrituresKpiRow } from "./ecritures-kpi-row";
import { EcrituresTable } from "./ecritures-table";
import { NewEcritureDialog } from "./new-ecriture-dialog";
import { PaymentDialog } from "./payment-dialog";
import { PaymentInfoBanner } from "./payment-info-banner";
import { PendingAlertBanner } from "./pending-alert-banner";
import type { useEcrituresScreen } from "./use-ecritures-screen";
  ...
  return (
    <TabsContent value="ecritures" className="mt-0 space-y-6">
      ...
      <PaymentDialog
        ...
        note={screen.note}
        submitting={screen.submittingPayment}
      ...
      <NewEcritureDialog
        ...
        submitting={screen.submittingNewEcriture}
