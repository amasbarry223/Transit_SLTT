        ...
        <div className="flex-1 p-5 sm:p-6">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-2 border-t border-border/50 pt-4">
            {!isEditing ? (
              ...
              <>
                <Button size="sm" variant="outline" className="gap-2" onClick={onCancelEdit} disabled={savingEdit}>
                  <X className="size-4" /> Annuler
                </Button>
                <Button size="sm" className="gap-2 bg-primary hover:bg-primary/90" onClick={onSaveEdit} disabled={savingEdit}>
                  <Save className="size-4" /> {savingEdit ? "Enregistrement…" : "Enregistrer"}
                </Button>
              </>
            )}
          </div>
