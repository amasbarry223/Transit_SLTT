  ...
  async function handleExport() {
    ...
    try {
      ...
      toast({
        ...
        description: `${payload.meta.tables.length} table(s) — ${formatFileSize(new Blob([json]).size)}.`,
      });
    } catch (e) {
      toast({
        title: "Export impossible",
        description: getErrorMessage(e, "Erreur lors de l'export."),
        variant: "destructive",
      });
    } finally {
      setExporting(false);
  ...
  async function handleFileSelected(file: File) {
    try {
      ...
      toast({
        ...
        description: getErrorMessage(e, "Impossible de lire ce fichier de sauvegarde."),
        variant: "destructive",
      });
    }
  }
  ...
  async function handleConfirmRestore() {
    ...
    try {
      ...
      toast({
        ...
        description: getErrorMessage(e, "Erreur lors de la restauration."),
        variant: "destructive",
      });
    } finally {
  ...
  async function handleConfirmWipe() {
    try {
      ...
      toast({
        ...
        description: `${totalRows(report)} ligne(s) supprimée(s) sur ${Object.keys(report).length} table(s).`,
      });
    } catch (e) {
      toast({
        title: "Suppression impossible",
        description: getErrorMessage(e, "Erreur lors de la suppression."),
        variant: "destructive",
      });
    }
  }
