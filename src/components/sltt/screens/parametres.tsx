      ...
      <Card className="p-6 shadow-sm border-border/80">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-semibold text-slate-900 dark:text-slate-100">{pNom || "Amadou Traoré"}</p>
              <p className="text-sm text-slate-500 dark:text-slate-400">Administrateur</p>
            </div>
          </div>
