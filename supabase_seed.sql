...
INSERT INTO public.dossiers (id, reference, client_id, bl, camion, nature, droit_douane, frais_circuit, frais_prestation, montant_investi, montant_paye, statut, date, date_echeance, date_dedouanement, checklist_docs, mode_transport, no_conteneur, port_entree, poids_total, notes)
VALUES 
  ('d0000000-0000-0000-0000-000000000042', 'SLTT-TR-2026-0042', 'c0000000-0000-0000-0000-000000000001', 'BL-7821', 'RJ 4521 KM', 'Matériel électronique', 1200000, 450000, 850000, 2500000, 1800000, 'En cours', '2026-01-08', '2026-01-12', NULL, ARRAY['bl', 'facture-commerciale'], 'Maritime', 'MSCU4521789', 'Port de Dakar', 12500, 'Conteneur 40 pieds, dédouanement en cours.'),
  ('d0000000-0000-0000-0000-000000000041', 'SLTT-TR-2026-0041', 'c0000000-0000-0000-0000-000000000004', 'BL-7790', 'KN 8890 PQ', 'Sacs de ciment', 980000, 320000, 600000, 1900000, 1900000, 'Soldé', '2026-01-05', '2026-01-10', '2026-01-08', ARRAY['bl', 'dau', 'bad', 'facture-commerciale', 'colisage', 'certif-origine', 'assurance'], 'Maritime', 'TRKU8890123', 'Port de Dakar', 24000, 'Livraison terminée.'),
  ('d0000000-0000-0000-0000-000000000040', 'SLTT-TR-2026-0040', 'c0000000-0000-0000-0000-000000000002', 'BL-7765', 'LM 3344 RT', 'Pièces automobiles', 1500000, 500000, 900000, 2900000, 2200000, 'Dédouané', '2026-01-03', '2026-01-11', '2026-01-10', ARRAY['bl', 'dau', 'bad', 'facture-commerciale', 'colisage'], 'Routier', NULL, 'Frontière Mali-Côte d''Ivoire', 8200, 'Camion en transit vers l''entrepôt.'),
  ('d0000000-0000-0000-0000-000000000039', 'SLTT-TR-2026-0039', 'c0000000-0000-0000-0000-000000000005', 'BL-7740', 'OP 1199 MN', 'Textiles & vêtements', 600000, 200000, 350000, 1150000, 800000, 'Livré', '2026-01-02', '2026-01-09', '2026-01-06', ARRAY['bl', 'dau', 'bad', 'facture-commerciale', 'colisage'], 'Routier', NULL, 'Frontière Sénégal-Mali', 5400, 'Livraison effectuée avec succès.'),
  ('d0000000-0000-0000-0000-000000000038', 'SLTT-TR-2026-0038', 'c0000000-0000-0000-0000-000000000007', 'BL-7712', 'QR 5566 ST', 'Équipements agricoles', 2100000, 700000, 1200000, 4000000, 4000000, 'Soldé', '2025-12-28', '2026-01-05', '2026-01-04', ARRAY['bl', 'dau', 'bad', 'facture-commerciale', 'colisage', 'assurance'], 'Maritime', 'MSCU9900223', 'Port de Dakar', 18500, NULL),
  ('d0000000-0000-0000-0000-000000000037', 'SLTT-TR-2026-0037', 'c0000000-0000-0000-0000-000000000003', 'BL-7688', 'UV 2233 WX', 'Électroménager', 450000, 150000, 300000, 900000, 900000, 'Soldé', '2025-12-22', '2025-12-29', '2025-12-27', ARRAY['bl', 'dau', 'facture-commerciale'], 'Maritime', 'MSCU1122334', 'Port de Dakar', 3200, NULL),
  ('d0000000-0000-0000-0000-000000000036', 'SLTT-TR-2026-0036', 'c0000000-0000-0000-0000-000000000001', 'BL-7655', 'RJ 4521 KM', 'Conserves alimentaires', 880000, 280000, 520000, 1680000, 1300000, 'En cours', '2025-12-18', '2025-12-25', NULL, ARRAY['bl', 'facture-commerciale'], 'Maritime', 'MSCU6655778', 'Port de Dakar', 15000, 'En attente de documents complémentaires.'),
  ('d0000000-0000-0000-0000-000000000035', 'SLTT-TR-2026-0035', 'c0000000-0000-0000-0000-000000000004', 'BL-7621', 'KN 8890 PQ', 'Carburant & lubrifiants', 1750000, 560000, 980000, 3290000, 2900000, 'Dédouané', '2025-12-15', '2025-12-22', '2025-12-20', ARRAY['bl', 'dau', 'bad', 'facture-commerciale', 'colisage'], 'Routier', NULL, 'Frontière Mali-Côte d''Ivoire', 32000, NULL),
  ('d0000000-0000-0000-0000-000000000034', 'SLTT-TR-2026-0034', 'c0000000-0000-0000-0000-000000000002', 'BL-7599', 'LM 3344 RT', 'Matériel informatique', 1320000, 410000, 720000, 2450000, 2450000, 'Soldé', '2025-12-10', '2025-12-17', '2025-12-15', ARRAY['bl', 'dau', 'bad', 'facture-commerciale', 'colisage', 'certif-origine', 'assurance'], 'Maritime', 'MSCU5566778', 'Port de Dakar', 4500, NULL),
  ('d0000000-0000-0000-0000-000000000033', 'SLTT-TR-2026-0033', 'c0000000-0000-0000-0000-000000000006', 'BL-7570', 'YZ 7788 AB', 'Mobilier domestique', 380000, 120000, 280000, 780000, 780000, 'Soldé', '2025-12-05', '2025-12-12', '2025-12-10', ARRAY['bl', 'dau', 'bad', 'facture-commerciale'], 'Maritime', 'MSCU1122445', 'Port de Dakar', 2800, NULL)
ON CONFLICT (id) DO NOTHING;
