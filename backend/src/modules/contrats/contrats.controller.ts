...
export class ContratsController {
  ...
  create(@CurrentUser() user: CurrentUserType, @Body() body: CreateContratDto) {
  ...
  update(@Param('id') id: string, @CurrentUser() user: CurrentUserType, @Body() body: UpdateContratDto) {
